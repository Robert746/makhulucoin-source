    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Makhulucoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Makhulucoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Makhulucoin"), this);
    aboutAction->setStatusTip(tr("Show information about Makhulucoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Makhulucoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Makhulucoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Makhulucoin addresses"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Makhulucoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Makhulucoin network", "", count));
}
...
{
    QString strTitle = tr("Makhulucoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Makhulucoin address or malformed URI parameters."),
...
void BitcoinGUI::downloadFile(QString url)
{
    ...
    {
#ifdef WIN32
        newurl += "/makhulucoin-qt_win.zip";
#elif LINUX
        newurl += "/makhulucoin-qt_linux.zip";
#else Q_OS_MAC
        newurl += "/makhulucoin-qt_mac.zip";
#endif
    }
    // get url
    QUrl url1(newurl);
